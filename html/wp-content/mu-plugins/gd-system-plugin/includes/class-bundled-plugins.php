...
final class Bundled_Plugins {
	...
	public function __construct() {
		...
		$bundled_plugins = [
			...
			'limit-login-attempts-reloaded/limit-login-attempts-reloaded.php' => version_compare( PHP_VERSION, '8.1', '<' ) && ! Plugin::is_plugin_active( 'sucuri-scanner/sucuri.php' ),
			'wpex/stock-photos/stock-photos.php'=> true,
			'worker/init.php'                   => true,
			'wpex/godaddy-launch/godaddy-launch.php' => version_compare( PHP_VERSION, '8.0.2', '>=' ) && Plugin::is_option_autoloaded( 'gdl_enabled', true ),
			'wpex/expert-banner/expert-banner.php' => true,
