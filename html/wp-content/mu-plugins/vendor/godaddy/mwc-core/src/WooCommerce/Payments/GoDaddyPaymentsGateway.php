...
class GoDaddyPaymentsGateway extends AbstractPaymentGateway implements SubscriberContract
{
    ...
    public function __construct()
    {
        ...
        $this->method_description = sprintf(
            ...
            __('Securely accept credit/debit cards in your checkout, and keep more of your money with the industry\'s lowest fees—just 2.3&#37; + 30&#162; per online transaction. Get paid fast with deposits as soon as the next day. %1$sGoDaddy Payments Terms apply%2$s.', 'mwc-core'),
