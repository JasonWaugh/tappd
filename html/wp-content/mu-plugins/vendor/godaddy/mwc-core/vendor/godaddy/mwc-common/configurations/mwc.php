...
return [
    ...
    'extensions' => [
         ...
         */
        'api' => [
            'dev-url'  => defined('MWC_EXTENSIONS_API_URL') ? MWC_EXTENSIONS_API_URL : 'https://api-dev.mwc.secureserver.net/v1',
            ...
            /*
             * Brands to exclude when retrieving extensions from the API
             */
            'excludedBrands' => [],
        ],
    ],
    ...
    'events' => [
         ...
         */
        'api' => [
            'dev-url' => defined('MWC_EVENTS_API_URL') ? MWC_EVENTS_API_URL : 'https://api-events-dev.mwc.secureserver.net',
